...
Track work here. Move items between sections as they progress.
Pick one item from "Up Next" before starting a coding session.
...
- [x] Phase 3: Requirements Panel + delete Step 1 — see `.specs/done/requirements-panel.md`
...
<!-- Dump ideas here. Refine into specs before working on them. -->
